...
class Trainer:
    def __init__(self, config):
        ...
        self.fix_flow_complete = RecurrentFlowCompleteNet('/home/sym/ProPainter_old/experiments_model/recurrent_flow_completion_train_flowcomp/gen_700000.pth')
    ...
    def _train_epoch(self, pbar):
        ...
        while train_data is not None:
            ...
            gen_loss.backward()
            torch.nn.utils.clip_grad_norm_(self.netG.parameters(), max_norm=5.0)#!+自己设置的
            self.optimG.step()
            ...
            if not self.config['model']['no_dis']:
                ...
                dis_loss.backward()
                torch.nn.utils.clip_grad_norm_(self.netD.parameters(), max_norm=5.0)#!1111
                self.optimD.step()
